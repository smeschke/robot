...
The robot is controlled by an ESP32. The ESP32 uses ESPNOW to communicate with a manual joystick, or an onboard computer. This allows the user to swith from 'auto' to 'manual' without touching any cords.
